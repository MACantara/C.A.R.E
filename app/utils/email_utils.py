...
def send_appointment_reminder(appointment):
    ...
    try:
        ...
        subject = f"C.A.R.E. - Appointment Reminder"
        ...
        mail.send(msg)
        current_app.logger.info(
            f"Appointment reminder sent to {appointment.patient.email}"
        )
        return True

    except Exception as e:
        current_app.logger.error(f"Failed to send appointment reminder: {e}")
        return False
